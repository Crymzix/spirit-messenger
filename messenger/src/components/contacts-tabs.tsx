            ...
            <div className="relative flex flex-col">
                {tabs.map((tab, index) => (
                    ...
                    >
                        ...
                        >
                            <defs>
                                <filter id="innerShadowTop" x="-50%" y="-50%" width="200%" height="200%">
                                    <feDropShadow dx="1" dy="1.5" stdDeviation="1.0" floodColor="#C0C9DE" />
                                </filter>

                                <filter id="innerShadowBottom" x="-50%" y="-50%" width="200%" height="200%">
                                    <feDropShadow dy="-1" stdDeviation="1.0" floodColor="#C0C9DE" />
                                </filter>

                                <filter id="innerShadowRight" x="-50%" y="-50%" width="200%" height="200%">
                                    <feDropShadow dx="1" stdDeviation="-2.0" floodColor="#C0C9DE" />
                                </filter>
                            </defs>

                            {
                                activeTab === index ?
                                    ...
                                    <path d="M0 4Q0 0 4 0L48 0 48 85 48 85Q38 73 25 67 0 54 0 47Z"
                                        fill="none"
                                        stroke="#B8C6EA"
                                        strokeWidth="1"
                                        filter="url(#innerShadowRight)"
                                    />
                            }
                        ...
                        {/* Icon on top */}
                        <img src={tab.icon} className="absolute h-[40px] top-2 object-cover" />
                    </div>
                ))}
            </div>
        </div>
